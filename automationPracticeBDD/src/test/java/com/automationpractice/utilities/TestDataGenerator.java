...
public final class TestDataGenerator { //final here means this class doesn't extend

	private static Logger logger = Logger.getLogger(TestDataGenerator.class);
	private static Faker faker = new Faker();
	
	private TestDataGenerator () {} // you add this private constructor so it doesn't extend or create object out of this class 
